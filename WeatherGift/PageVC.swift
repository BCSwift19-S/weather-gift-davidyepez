...
class PageVC: UIPageViewController {
    ...
    func loadLocations() {
        ...
        if let locationsArray = try?
            decoder.decode(Array.self, from: locationsEncoded) as [WeatherLocation] {
    ...
    func configureListButton() {
        ...
        listButton = UIButton(frame: CGRect(x: view.fram.width - barButtonWidth, y: safeHeight - barButtonHeight, width: barButtonWidth, height: barButtonHeight))
